...
local function OnEvent(event, arg1)
	if (event == "ADDON_LOADED") then
		if (addonName == arg1) then
			--MergeWorldMapFrame()
			-- instance difficulty override for Stanzilla - move this to a more appropriate location
			if (TomCats_Account.minimapInstanceDifficultyAnchorOverride[1]) then
				...
				MiniMapInstanceDifficulty:SetPoint(override1, override2, override3, override4)
			end
		end
	end
end
