...
local C_MapInternal = C_MapInternal
local CancelEmote = CancelEmote
...
local HelpPlate_ShowTutorialPrompt = TomCats_HelpPlate_ShowTutorialPrompt
local HelpPlate_TooltipHide = HelpPlate_TooltipHide
local HelpPlateTooltip_IsShowing = TomCats_HelpPlateTooltip_IsShowing
local HideUIPanel = HideUIPanel
local IsGMClient = IsGMClient
local LE_FRAME_TUTORIAL_WORLD_MAP_FRAME = LE_FRAME_TUTORIAL_WORLD_MAP_FRAME
local MAP_AND_QUEST_LOG = MAP_AND_QUEST_LOG
local MapCanvasMixin = TomCats_MapCanvasMixin
...
local RestoreUIPanelArea = RestoreUIPanelArea
...
local BannerDataProvider = TomCats_BannerDataProvider
local BattlefieldFlagDataProviderMixin = TomCats_BattlefieldFlagDataProviderMixin
local BonusObjectiveDataProviderMixin = TomCats_BonusObjectiveDataProviderMixin
local ContributionCollectorDataProviderMixin = TomCats_ContributionCollectorDataProviderMixin
local DeathMapDataProviderMixin = TomCats_DeathMapDataProviderMixin
local DigSiteDataProviderMixin = TomCats_DigSiteDataProviderMixin
local DungeonEntranceDataProviderMixin = TomCats_DungeonEntranceDataProviderMixin
local EncounterJournalDataProviderMixin = TomCats_EncounterJournalDataProviderMixin
local FlightPointDataProviderMixin = TomCats_FlightPointDataProviderMixin
local FogOfWarDataProviderMixin = TomCats_FogOfWarDataProviderMixin
local GarrisonPlotDataProviderMixin = TomCats_GarrisonPlotDataProviderMixin
local GroupMembersDataProviderMixin = GroupMembersDataProviderMixin
local GossipDataProviderMixin = TomCats_GossipDataProviderMixin
local InvasionDataProviderMixin = TomCats_InvasionDataProviderMixin
local MapExplorationDataProviderMixin = TomCats_MapExplorationDataProviderMixin
local MapHighlightDataProviderMixin = TomCats_MapHighlightDataProviderMixin
local MapIndicatorQuestDataProviderMixin = TomCats_MapIndicatorQuestDataProviderMixin
local MapLinkDataProviderMixin = TomCats_MapLinkDataProviderMixin
local PetTamerDataProviderMixin = TomCats_PetTamerDataProviderMixin
local QuestBlobDataProviderMixin = TomCats_QuestBlobDataProviderMixin
local QuestDataProviderMixin = TomCats_QuestDataProviderMixin
local QuestSessionDataProviderMixin = TomCats_QuestSessionDataProviderMixin
local ScenarioDataProviderMixin = TomCats_ScenarioDataProviderMixin
local SelectableGraveyardDataProviderMixin = TomCats_SelectableGraveyardDataProviderMixin
local StorylineQuestDataProviderMixin = TomCats_StorylineQuestDataProviderMixin
local VehicleDataProviderMixin = TomCats_VehicleDataProviderMixin
local VignetteDataProviderMixin = TomCats_VignetteDataProviderMixin
local WaypointLocationDataProviderMixin = TomCats_WaypointLocationDataProviderMixin
local WorldMap_DebugDataProviderMixin = TomCats_WorldMap_DebugDataProviderMixin
...
function WorldMapMixin:OnLoad()
	...
	-- todo: work-around absence of these events
...
--todo: identify the needed providers and port+enable them
...
--todo: identify the needed overlay frames and port+enable them
function WorldMapMixin:AddOverlayFrames()
	...
	self.NavBar = self:AddOverlayFrame("TomCats_WorldMapNavBarTemplate", "FRAME");
	self.NavBar:SetPoint("TOPLEFT", self.TitleCanvasSpacerFrame, "TOPLEFT", 64, -25);
	self.NavBar:SetPoint("BOTTOMRIGHT", self.TitleCanvasSpacerFrame, "BOTTOMRIGHT", -4, 9);

	self.SidePanelToggle = self:AddOverlayFrame("TomCats_WorldMapSidePanelToggleTemplate", "BUTTON", "BOTTOMRIGHT", self:GetCanvasContainer(), "BOTTOMRIGHT", -2, 1);
end
