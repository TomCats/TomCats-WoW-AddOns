...
local ITEMTYPE = { }
do
	local types = {"CLOAK","CLOTH_ARMOR","LEATHER_ARMOR","MAIL_ARMOR","OFFHAND","PLATE_ARMOR","SHIELDS_ARMOR","WEAPON_1H_AXE","WEAPON_1H_MACE","WEAPON_1H_SWORD","WEAPON_2H_SWORD","WEAPON_CROSSBOW","WEAPON_DAGGER","WEAPON_POLEARM","WEAPON_STAFF"}
