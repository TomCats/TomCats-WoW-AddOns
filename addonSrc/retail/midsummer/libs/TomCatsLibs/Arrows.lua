...
local lib = addon.midsummer.TomCatsLibs.Arrows
local Colors = addon.midsummer.TomCatsLibs.Colors
local imagePath = "Interface\\AddOns\\TomCats-Midsummer\\libs\\TomCatsLibs\\images\\"
