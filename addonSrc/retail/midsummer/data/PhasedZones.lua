...
D.loadData(
    ...
    { "UIMap ID", "Quest IDs", "Timewalking NPC POI ID", "Visible UIMap IDs", "Timewalking Map Art ID", "Alt Phase Zone", "Phase Quest ID", "Phase Complete Status" },
    {
        ...
        { 90, { 9330 }, 5757, { 12 }, nil, 18, 52758, true }, -- Undercity
        { 89, { 11935 }, 5760, { 13 }, nil, 62, 54411, true }, -- Darnassus
        { 17, { 28917, 11808, 11737, 28930 }, 5562, { 13 }, 18 }, -- blasted lands
        { 249, { 28948, 28950, 28947, 28949 }, 6549, { 12 }, nil, 1527, 50659, true }, -- Uldum
        { 390, { 32496, 32510, 32503, 32509 }, 6574, { 424 }, nil, 1530, 59024, true }, -- Vale of Eternal Blossom
    }
)
