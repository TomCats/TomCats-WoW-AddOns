...
if (PlayerFaction == "Horde") then
    addon.midsummer.TomCatsLibs.Data.loadData(
            ...
            { "Entrance ID", "Quest IDs", "UIMap ID", "Location", "Type", "Add to Parent UIMaps" },
            {
                ...
                { 10, {11935, 11753}, 57, Coords(0.5479,0.8826), TYPE_PORTAL_ALLIANCE, true }, --Darnassus additional pin
    ...
    addon.midsummer.TomCatsLibs.Data.loadData(
            ...
            { "Entrance ID", "Quest IDs", "UIMap ID", "Location", "Type", "Add to Parent UIMaps" },
            {
                ...
                { 11, {11824}, 57, Coords(0.5232,0.8947), TYPE_PORTAL_ALLIANCE, true }, --Teldrassil additional pin
