...
local promoData = {
	...
	--},
	{
		...
		startTime = 1701192600,
		endTime = 1703611740,
		lang = {
			["enUS"] = {
				urlParams = { "en-us" },
				title1 = "In-game content, free with Prime:",
				title2 = "\nTabard of Fury Transmog\n\nShow off your passion for battle with the Tabard of Fury.",
				click = "Click for details" },
			["frFR"] = {
				urlParams = { "fr-fr" },
				title1 = "Contenu en jeu gratuit avec Prime:",
				title2 = "\nTransmogrification Tabard de la fureur\n\nMontrez votre passion guerrière avec le Tabard de la fureur.",
				click = "Cliquer pour les détails" },
			["deDE"] = {
				urlParams = { "de-de" },
				title1 = "Kostenlos mit Prime erhältliche Spielinhalte:",
				title2 = "\nTransmog „Wappenrock des Furors“\n\nZeige deine Leidenschaft für den Kampf mit dem Wappenrock des Furors.",
				click = "Klicken Sie für weitere Details" },
			["esES"] = {
				urlParams = { "es-es" },
				title1 = "Contenido de juegos, gratis con Prime:",
				title2 = "\nTransfiguración del Tabardo de furia\n\nDemuestra tu pasión por la batalla con el Tabardo de furia.",
				click = "Haga clic para obtener más detalles" },
			["esMX"] = {
				urlParams = { "es-mx" },
				title1 = "Contenido en el juego gratis con Prime:",
				title2 = "\nTransfiguración Tabardo de furia\n\nDemuestra tu pasión por la batalla con el Tabardo de furia.",
				click = "Haga clic para obtener más detalles" },
			["itIT"] = {
				urlParams = { "it-it" },
				title1 = "Contenuti di gioco, gratis con Prime:",
				title2 = "\nTrasmog Insegna della Furia\n\nMostra la tua passione per la battaglia con l’Insegna della Furia.",
				click = "Clicca per maggiori dettagli" },
			["ptBR"] = {
				urlParams = { "pt-br" },
				title1 = "Conteúdo do jogo grátis com Prime:",
				title2 = "\nTransmogrificação Tabardo da Fúria\n\nMostre sua paixão pela batalha com o Tabardo da Fúria.",
				click = "Clique para mais detalhes" },
			["ptPT"] = {
				urlParams = { "pt-pt" },
				title1 = "Conteúdo de jogo, grátis com o Prime:",
				title2 = "\nTransmog Tabardo de Fúria\n\nMostra a tua paixão pela batalha com o Tabardo de Fúria.",
				click = "Clique para mais detalhes" },
		},
		url = "https://gaming.amazon.com/tabard-fury-transmog",
		slug = "prime_tabardoffury",
		modelInfo = {
			items = { 38313, 10054, 109880, 190907, 61520, 29936 }
