	...
	},
	{
		...
		lang = {
			["enUS"] = {
				...
				title2 = "\nArmored Bloodwing Mount\n\nThe undefeated ruler of the night skies.",
				click = "Click for details" },
			["frFR"] = {
				urlParams = { "fr-fr" },
				title1 = "Contenu en jeu gratuit avec Prime:",
				title2 = "\nMonture aile-de-sang cuirassé\n\nLe maître incontesté des cieux nocturnes.",
				click = "Cliquer pour les détails" },
			["deDE"] = {
				urlParams = { "de-de" },
				title1 = "Kostenlos mit Prime erhältliche Spielinhalte:",
				title2 = "\nReittier „Gepanzerte Blutschwinge“\n\nUnangefochtene Herrscherin des Nachthimmels.",
				click = "Klicken Sie für weitere Details" },
			["esES"] = {
				urlParams = { "es-es" },
				title1 = "Contenido de juegos, gratis con Prime:",
				title2 = "\nMontura Alasangre acorazado\n\nEl rey indiscutible de los cielos nocturnos.",
				click = "Haga clic para obtener más detalles" },
			["esMX"] = {
				urlParams = { "es-mx" },
			...
			["itIT"] = {
				...
				title2 = "\nCavalcatura Alacremisi Corazzato\n\nL'imbattuto dominatore dei cieli notturni.",
				click = "Clicca per maggiori dettagli" },
			["ptBR"] = {
				urlParams = { "pt-br" },
				title1 = "Conteúdo do jogo grátis com Prime:",
				title2 = "\nMontaria Asarrubra Encouraçado\n\nO senhor absoluto do céu noturno.",
				click = "Clique para mais detalhes" },
			["ptPT"] = {
				urlParams = { "pt-pt" },
				title1 = "Conteúdo de jogo, grátis com o Prime:",
				title2 = "\nMontada Asarrubra Encouraçado\n\nO dominador invicto dos céus noturnos.",
				click = "Clique para mais detalhes" },
		},
		url = "https://gaming.amazon.com/armored-bloodwing-mount",
		slug = "prime_armoredbloodwing",
		modelInfo = {
			creature = 70356,
