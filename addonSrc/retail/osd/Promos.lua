...
local promoData = {
	...
	--			click = "Clique para mais detalhes" },
	--	},
	--	url = "https://worldofwarcraft.blizzard.com/%s/news/24165462/",
	--	slug = "prime_cowards_azure_target",
	--	modelInfo = {
	--		items = { 3427, 10035, 6836, 233207 },
	--		--			creature = 138741,
	...
	{
		type = promoTypes.TWITCH_DROP,
		startTime = 1740506400,
		endTime = 1742922000,
		lang = {
			["enUS"] = {
				urlParams = { "en-us" },
				title1 = "Twitch Drop:",
				title2 = "Get Tock the Clocker Spaniel Pet",
				click = "Click for details" },
			["enGB"] = {
				urlParams = { "en-gb" },
				title1 = "Twitch Drop:",
			...
			["frFR"] = {
				urlParams = { "fr-fr" },
				title1 = "Drop Twitch:",
				title2 = "obtenez la mascotte Tac, l’épagneul de l’horloge",
				click = "Cliquer pour les détails" },
			["deDE"] = {
				urlParams = { "de-de" },
				title1 = "Twitch-Drop:",
				title2 = "Verdient euch Tock die Uhrdogge als Haustier",
				click = "Klicken Sie für weitere Details" },
			["esES"] = {
				urlParams = { "es-es" },
				title1 = "Drop de Twitch:",
				title2 = "Hazte con la mascota Tock, el can mecanizado.",
				click = "Haga clic para obtener más detalles" },
			["zhTW"] = {
				urlParams = { "zh-tw" },
				title1 = "Twitch 掉寶：",
			...
			["esMX"] = {
				urlParams = { "es-mx" },
				title1 = "Drop de Twitch:",
				title2 = "¡La mascota Tictac, el Perrolex!",
				click = "Haga clic para obtener más detalles" },
			["ptBR"] = {
				urlParams = { "pt-br" },
				title1 = "Twitch Drop:",
				title2 = "receba Tic-tac, o Cronococker Spaniel",
				click = "Clique para mais detalhes" },
			["ptPT"] = {
				urlParams = { "pt-br" },
				title1 = "Twitch Drop:",
			...
			["itIT"] = {
				urlParams = { "it-it" },
				title1 = "Twitch Drop:",
				title2 = "Ottieni la mascotte Tictoc l'Orocker Spaniel",
				click = "Clicca per maggiori dettagli" },
		},
		url = "https://news.blizzard.com/%s/article/24177682/",
		slug = "twitch_clocker_spaniel",
		modelInfo = {
			model = 6236785,
			display = 127497
		},
