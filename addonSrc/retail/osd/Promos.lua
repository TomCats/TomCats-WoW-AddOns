	...
	--},
	{
		...
		lang = {
			["enUS"] = {
				urlParams = { "en-us" },
				title1 = "Twitch Drop:",
				title2 = "Get the Coward’s Azure Target Transmog",
				click = "Click for details" },
			["enGB"] = {
				urlParams = { "en-gb" },
				title1 = "Twitch Drop:",
			...
			["frFR"] = {
				urlParams = { "fr-fr" },
				title1 = "Drop Twitch:",
				title2 = "obtenez la transmogrification Cible azur du lâche",
				click = "Cliquer pour les détails" },
			["deDE"] = {
				urlParams = { "de-de" },
				title1 = "Twitch-Drop:",
				title2 = "Erhaltet des Feiglings azurblaue Zielscheibe als Transmog",
				click = "Klicken Sie für weitere Details" },
			["esES"] = {
				urlParams = { "es-es" },
				title1 = "Drop de Twitch:",
				title2 = "Hazte con la transfiguración objetivo azur del cobarde.",
				click = "Haga clic para obtener más detalles" },
			["zhTW"] = {
				urlParams = { "zh-tw" },
				title1 = "Twitch 掉寶：",
			...
			["esMX"] = {
				urlParams = { "es-mx" },
				title1 = "Drop de Twitch:",
				title2 = "Obtén la transfiguración Blanco del cobarde azur",
				click = "Haga clic para obtener más detalles" },
			["ptBR"] = {
				urlParams = { "pt-br" },
				title1 = "Twitch Drop:",
				title2 = "garanta a transmogrificação Alvo Lazúli do Covarde",
				click = "Clique para mais detalhes" },
			["ptPT"] = {
				urlParams = { "pt-br" },
				title1 = "Twitch Drop:",
			...
			["itIT"] = {
				urlParams = { "it-it" },
				title1 = "Twitch Drop:",
				title2 = "ottieni la trasmogrificazione Bersaglio Azzurro del Codardo",
				click = "Clicca per maggiori dettagli" },
		},
		url = "https://worldofwarcraft.blizzard.com/%s/news/24165462/",
		slug = "prime_cowards_azure_target",
