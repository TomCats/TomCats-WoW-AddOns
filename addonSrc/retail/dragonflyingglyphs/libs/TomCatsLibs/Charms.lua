...
addon.dragonflyingglyphs.Charms = { }
...
function addon.dragonflyingglyphs.Charms.Create(buttonInfo)
    ...
    local frame = CreateFrame("Button", name, Minimap, "TomCats-DragonFlyingGlyphsMinimapButtonTemplate");
